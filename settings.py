# Django settings for schneiderlein project.
import os
...
SECRET_KEY = 'pa&4dtocip76qfc=bs-u$m=4lc0-kcam_-4_rb!7uu!ryflcdk'
...
ROOT_URLCONF = 'schneiderlein.urls'
